        ...
        <div className="mission-about">
          <div className="mission-txt">
            <div>
              ...
              <p>
                Enim ad minim veniam quis nostrud exercitation ullam laboris
                nisi utco aliquip exea pmmodo consequat duis aute. Lorem ipsum
                dolor sit amet consectetur adipisicing elit sed eiusmod tempor
                incididunt labore duis irure dolor in reprehenderit.
              </p>
              <p>
                Magna aliqua Uat enim ad minim veniam quis nostrud exercit ation
                ullamco laboris aliquip consequat.
              </p>
            </div>
          </div>
        ...
        <div className=" container">
          <div className="projects_done">
            <div className="projects_content">
              ...
              <p>
                Mollit anim idm est laborum sed ut perspiciatis unde omniste
                voluptate macsit cusa ntium doloremque laudantium totam labore
                dolore magna aliquat enim ad minim veniam quis nost rctation
                ullamco laboris aliquip consequat sed ipsum dolore.
              </p>
              ...
              <div className="featured-services-right  ">
                <div className="b-work-steps">
                  <div className="b-services-item">
                    ...
                    <div className="services-text">
                      <h6 className="services-title  customPseudoElBg font-secondary text-uppercase">
                        <span className="customColor">1.</span>
                        BRAINSTORMING
                      </h6>
                      <p>
                        Labore et dolore magna aliqua en minim veniam quis
                        nostrud ulamc
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="b-services-item">
                    ...
                    <div className="services-text">
                      <h6 className="services-title  customPseudoElBg font-secondary text-uppercase">
                        <span className="customColor">2.</span>
                        PROJECT SKETCHING
                      </h6>
                      <p>
                        Labore et dolore magna aliqua en minim veniam quis
                  ...
                  <div className="b-services-item">
                    ...
                    <div className="services-text">
                      <h6 className="services-title  customPseudoElBg font-secondary text-uppercase">
                        <span className="customColor">3.</span>
                        DESIGN &amp; DEVELOPMENT
                      </h6>
                      <p>
                        Labore et dolore magna aliqua en minim veniam quis
                  ...
                  <div className="b-services-item">
                    ...
                    <div className="services-text">
                      <h6 className="services-title  customPseudoElBg font-secondary text-uppercase">
                        <span className="customColor">4.</span>
                        PROJECT DELIVERED
                      </h6>
                      <p>
                        Labore et dolore magna aliqua en minim veniam quis
